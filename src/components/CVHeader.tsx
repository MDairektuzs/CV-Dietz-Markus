      ...
      <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">- Shaper PST-VIII Reporting &amp; Analytics bei SF.D</p>
            <p className="text-sm text-muted-foreground">- LPO "OtD.00.05 – Data Analytics OtD"</p>
            <p className="text-sm text-muted-foreground">- GenAI-Multiplikator@TA-13 &amp; SF.D</p>
